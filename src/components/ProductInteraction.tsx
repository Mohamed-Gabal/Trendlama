...
const ProductInteraction = ({
  ...
  return (
    <div className="flex flex-col gap-4 mt-4">
      ...
      {/* BUTTONS */}
      <button onClick={handleToCart} className= "bg-gray-800 text-white px-4 py-2 rounded-md shadow-lg flex items-center justify-center gap-2 cursor-pointer text-sm">
